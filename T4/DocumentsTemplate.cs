...
this.Write("<%@ Page Title=\"Documents\" Language=\"C#\" MasterPageFile=\"~/Site.master\" AutoEvent" +
        ...
        "=\"True\" ShowHeaderFilterButton=\"true\" />\r\n\t\t<ClientSideEvents CustomButtonClick=" +
        "\"OnCustomButtonClick\" EndCallback=\"OnGridEndCallback\" />\r\n    </dx:ASPxGridView>" +
        "\r\n    <asp:EntityDataSource ID=\"FileDataSource\" runat=\"server\" \r\n        Connect" +
        "ionString=\"name=SiteVisitMetaEntities\" \r\n        DefaultContainerName=\"SiteVisit" +
        "MetaEntities\" EnableFlattening=\"False\" \r\n        EntitySetName=\"ProjectFiles\">\r\n" +
