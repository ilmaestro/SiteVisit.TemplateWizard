...
namespace OnSite.TemplateWizard.Classes
{
    ...
    #line 1 "C:\Users\ryan.kilkenny\Documents\Workspace\On-Site\Admin\OnSite.TemplateWizard\T4\ReportAppointmentsTemplate.tt"
...
#line hidden
        ...
        public virtual string TransformText()
        {
            ...
            #line 2 "C:\Users\ryan.kilkenny\Documents\Workspace\On-Site\Admin\OnSite.TemplateWizard\T4\ReportAppointmentsTemplate.tt"
...
switch (OutputType) {
	...
	default:
        ...
        #line 16 "C:\Users\ryan.kilkenny\Documents\Workspace\On-Site\Admin\OnSite.TemplateWizard\T4\ReportAppointmentsTemplate.tt"
    ...
    void GeneratePage(SiteVisit sitevisit, IEnumerable<SiteVisitForm> forms)
    {
        ...
        #line 33 "C:\Users\ryan.kilkenny\Documents\Workspace\On-Site\Admin\OnSite.TemplateWizard\T4\ReportAppointmentsTemplate.tt"
...
<script type=""text/javascript"" src=""https://maps.googleapis.com/maps/api/js?sensor=false&key=AIzaSyDg2r9hOucSc8Whgr-4-bfvbXBvzSEIAR0""></script>
    <script type=""text/javascript"">
        ...
        #line 59 "C:\Users\ryan.kilkenny\Documents\Workspace\On-Site\Admin\OnSite.TemplateWizard\T4\ReportAppointmentsTemplate.tt"
...
this.Write(@".LocationLongitude;', function (values) {
        ...
        #line 86 "C:\Users\ryan.kilkenny\Documents\Workspace\On-Site\Admin\OnSite.TemplateWizard\T4\ReportAppointmentsTemplate.tt"
this.Write(this.ToStringHelper.ToStringWithCulture(pkey));
...
this.Write("\" && grid.columns[x].fieldName != \"SiteVisitAppointmentID\" && grid.columns[x].vis" +
        ...
        "       <td>\r\n                <dx:ASPxButton ID=\"btnCsvExport\" runat=\"server\" Tex" +
        "t=\"Export to Csv\" UseSubmitBehavior=\"False\" />\r\n            </td>\r\n            <" +
        "td>            \r\n                <dx:ASPxButton ID=\"btnResetToDefault\" AutoPostB" +
        "ack=\"false\" runat=\"server\" Text=\"Reset Columns\">\r\n                    <ClientSid" +
        "eEvents Click=\"function(s,e){ASPxClientUtils.DeleteCookie(\'");

        
        #line default
        #line hidden
        
        #line 160 "C:\Users\ryan.kilkenny\Documents\Workspace\On-Site\Admin\OnSite.TemplateWizard\T4\ReportAppointmentsTemplate.tt"
this.Write(this.ToStringHelper.ToStringWithCulture(table));
        ...
        #line 160 "C:\Users\ryan.kilkenny\Documents\Workspace\On-Site\Admin\OnSite.TemplateWizard\T4\ReportAppointmentsTemplate.tt"
this.Write(@"AppointmentsCookie'); window.location = window.location;}"" />
                </dx:ASPxButton>
            </td>
        </tr>
    </table>
    ...
    <dx:ASPxGridView ID=""grid"" runat=""server"" AutoGenerateColumns=""False"" ClientInstanceName=""grid"" 
        ...
        #line 167 "C:\Users\ryan.kilkenny\Documents\Workspace\On-Site\Admin\OnSite.TemplateWizard\T4\ReportAppointmentsTemplate.tt"
this.Write(this.ToStringHelper.ToStringWithCulture(table));
...
this.Write("AppointmentID\">\r\n        <Columns>\r\n            <dx:GridViewDataTextColumn FieldN" +
        ...
        #line 169 "C:\Users\ryan.kilkenny\Documents\Workspace\On-Site\Admin\OnSite.TemplateWizard\T4\ReportAppointmentsTemplate.tt"
this.Write(this.ToStringHelper.ToStringWithCulture(pkey));
...
this.Write("\" Caption=\"Contact ID\" ReadOnly=\"True\" Visible=\"true\"\r\n                VisibleInd" +
        ...
        "dx:GridViewDataColumn FieldName=\"SiteVisitAppointment.AppointmentStartDate\" Capt" +
        "ion=\"Start Date\" VisibleIndex=\"7\">\r\n            </dx:GridViewDataColumn>        " +
        "    \r\n            <dx:GridViewDataTimeEditColumn FieldName=\"SiteVisitAppointment" +
        ".AppointmentStartDate\" Caption=\"Start Time\" VisibleIndex=\"7\">\r\n            </dx:" +
        "GridViewDataTimeEditColumn>\r\n\t\t\t<dx:GridViewDataColumn FieldName=\"SiteVisitAppoi" +
        "ntment.AppointmentEndDate\" Caption=\"End Date\" VisibleIndex=\"8\">\r\n            </d" +
        "x:GridViewDataColumn>            \r\n            <dx:GridViewDataTimeEditColumn Fi" +
        "eldName=\"SiteVisitAppointment.AppointmentEndDate\" Caption=\"End Time\" VisibleInde" +
        "x=\"8\">\r\n            </dx:GridViewDataTimeEditColumn>\r\n            <dx:GridViewDa" +
        "taTextColumn FieldName=\"SiteVisitAppointment.Status\" VisibleIndex=\"10\" Visible=\"" +
        "false\">\r\n            </dx:GridViewDataTextColumn>\r\n            <dx:GridViewDataT" +
        "extColumn FieldName=\"SiteVisitAppointment.Label\" VisibleIndex=\"11\" Visible=\"fals" +
        "e\">\r\n            </dx:GridViewDataTextColumn>\r\n");
        ...
        #line 197 "C:\Users\ryan.kilkenny\Documents\Workspace\On-Site\Admin\OnSite.TemplateWizard\T4\ReportAppointmentsTemplate.tt"
...
this.Write("\r\n");
        ...
        #line 198 "C:\Users\ryan.kilkenny\Documents\Workspace\On-Site\Admin\OnSite.TemplateWizard\T4\ReportAppointmentsTemplate.tt"
...
this.Write("\r\n\t\t\t<dx:GridViewDataTextColumn FieldName=\"");
        ...
        #line 199 "C:\Users\ryan.kilkenny\Documents\Workspace\On-Site\Admin\OnSite.TemplateWizard\T4\ReportAppointmentsTemplate.tt"
this.Write(this.ToStringHelper.ToStringWithCulture(table));
...
this.Write(".SchedulerNotes\" VisibleIndex=\"997\">\r\n            </dx:GridViewDataTextColumn>\r\n " +
        ...
        #line 201 "C:\Users\ryan.kilkenny\Documents\Workspace\On-Site\Admin\OnSite.TemplateWizard\T4\ReportAppointmentsTemplate.tt"
this.Write(this.ToStringHelper.ToStringWithCulture(table));
...
this.Write(".LocationLatitude\" \r\n                ReadOnly=\"True\" VisibleIndex=\"998\" Visible=\"" +
        ...
        #line 204 "C:\Users\ryan.kilkenny\Documents\Workspace\On-Site\Admin\OnSite.TemplateWizard\T4\ReportAppointmentsTemplate.tt"
this.Write(this.ToStringHelper.ToStringWithCulture(table));
...
this.Write(@".LocationLongitude"" 
        ...
        #line 211 "C:\Users\ryan.kilkenny\Documents\Workspace\On-Site\Admin\OnSite.TemplateWizard\T4\ReportAppointmentsTemplate.tt"
this.Write(this.ToStringHelper.ToStringWithCulture(table));
        ...
        #line 211 "C:\Users\ryan.kilkenny\Documents\Workspace\On-Site\Admin\OnSite.TemplateWizard\T4\ReportAppointmentsTemplate.tt"
this.Write(@"AppointmentsCookie"" Enabled=""true"" StoreColumnsVisiblePosition=""true"" StoreFiltering=""false"" StoreGroupingAndSorting=""false"" StorePaging=""false"" />
